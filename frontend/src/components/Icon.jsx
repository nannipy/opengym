...
const P = {
  ...
  chat: <><path d="M4 6.4A2.4 2.4 0 0 1 6.4 4h11.2A2.4 2.4 0 0 1 20 6.4v8.2a2.4 2.4 0 0 1-2.4 2.4H8.4L4.8 20v-3H4a2.4 2.4 0 0 1-2.4-2.4V6.4Z" /><path d="M7.6 9.4h8.8M7.6 13h5.4" /></>,
}
